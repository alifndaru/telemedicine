...
<html>
  <head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>asset/admin/plugins/font-awesome-4.7.0/css/font-awesome.min.css">
    <!-- Ionicons -->
    ...
    <!-- Css custom -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>asset/admin/plugins/vue-timepicker/VueTimepicker.css">
    <!-- <link rel="stylesheet" href="<?php echo base_url(); ?>asset/admin/plugins/jquery-timepicker/jquery.timepicker.css"> -->
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1> Halaman Utama Administrator  </h1>
        </section>
    ...
    <script src="<?php echo base_url(); ?>asset/admin/chat-konsultasi.js"></script>
