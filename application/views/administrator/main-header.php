  ...
  .sekolah:hover{
    color:#fff;
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-lg"><b>PKBI CARE</b></span>
        </a>
        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top" role="navigation" id="navue">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <i class="fa fa-envelope-o"></i> &nbsp;Chat Konsultasi
                  <span class="label label-success">{{ all }}</span>
                </a>
                <ul class="dropdown-menu">
                  <li>
                    <ul class="menu">
                      <li v-for="(item, index, i) in items">
                        <a target="_blank" :href="index">Konsultasi #{{i+1}} (<b>{{ item }}</b>)</a>
                      </li>
                    </ul>
                  </li>
                </ul>
