              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    $komentar = $this->db->query("SELECT * FROM komentar where id_berita='$row[id_berita]'")->num_rows();
                    $user = $this->db->query("SELECT * FROM users where username='$row[username]'")->row_array();
                    echo "<tr><td>$no</td>
                              <td><a target='_BLANK' href='".base_url()."berita/detail/$row[judul_seo]'>$row[judul]</a></td>
