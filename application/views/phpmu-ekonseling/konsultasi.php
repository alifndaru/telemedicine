...
<div class="row container">
    ...
    <?php if ($usr['blokir']=='Y'){
      ...
      //echo "<h2>$title  <a href='".base_url()."user/tambah-konsultasi' class='btn btn-sm btn-primary pull-right'>Tambahkan Data</a> </h2><br>";
    }
		...
		<table id="example1" class="table table-bordered table-striped">
          ...
          header("refresh: 30; url = ".base_url('user/konsultasi'));
            ...
            if ($row['status']=='Y'){ $status = '<b><span style="color:#3333FF">Berlangsung</span></b> <br><small><i></i></small>'; }else{ $status = '<b><span style="color:#FF0000">Selesai</span></b> <br><small><i></i></small>'; }
