...
<div class="breadcrumb">
	<a href="<?php echo base_url('/'); ?>"><i class="fa fa-home"></i> Home</a> » <a href="<?php echo base_url()."kategori/detail/$rows[kategori_seo]"; ?>" rel="category tag"><?php echo "$rows[nama_kategori]"; ?></a> » <?php echo "$rows[judul]"; ?> 
</div>  
  		...
  		if ($total_komentar>='1'){ ?>
	        ...
	        <ul class="media-list comment-list">
                ...
                if ($this->session->level!='inovator'){
                  $komentar = $this->model_utama->view_where_ordering_limit('komentar',array('id_berita' => $rows['id_berita']),'id_komentar','ASC',0,100);
                }else{
