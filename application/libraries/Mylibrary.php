...
class Mylibrary{
	...
	function e101($item, $length) {
		$t1 = random_string('alnum', 101);
        $t2 = substr_replace($t1, $item, 53, $length);
		$t3 = substr_replace($t2, $length, -1);
	...
	function d101($text, $length) {
		return substr($text, 53, $length);
	}
